                    ...
                    <form method="post" action="{{ route('admins.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-md-3">
                                ...
                                <div class="m-b-15">
                                    <select class="form-control" name="nrc_no" id="nrc_no" required>
                                        @for ($i = 1; $i <= 14; $i++)
                                            <option value="{{ $i }}" {{ $admin->nrc_no == $i ? 'selected' : ''}}>
                                                {{ $i }}/
                                            </option>
                                        @endfor
                                    </select>
                                ...
                                <div class="m-b-15">
                                    <select class="form-control" name="nrc_location" id="nrc_location" required>
                                        @foreach ($nrc_numbers as $nrc_number)
                                            @if($admin->nrc_location == $nrc_number->id)
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="number" class="form-control" id="nrc_number" value="{{ $admin->nrc_number }}"
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="address" name="address" value="{{ $admin->address }}" required>
                            </div>
                            <div class="form-group col-md-3">
                                ...
                                <select class="form-control" name="state" id="state" required>
                                    ...
                                    @foreach ($states as $state)
                                        <option value="{{optional($state)->code}}" {{ $admin->state == $state->code ? 'selected' : ''}}>
                                            {{ $state->name }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <label for="township" class="h5">City/Township</label>
                                    <div class="m-b-15">
                                        <select class="form-control" name="city" id="city" required>
                                            ...
                                            <option value="{{$admin->city}}" selected>{{optional($admin)->city}}</option>
                                        </select>
                                    </div>
                            </div>
                        </div>
