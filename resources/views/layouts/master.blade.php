                        ...
                        <li class="dropdown dropdown-animated scale-left">
                            <div class="pointer" data-toggle="dropdown">
                                <div class="avatar avatar-image  m-h-10 m-r-15">
                                    <img src="{{ asset('img/admin/'.Auth::user()->avatar) }}" alt="">
                                </div>
                            </div>
                            <div class="p-b-15 p-t-20 dropdown-menu pop-profile">
                                ...
                                <a href="{{ route('admins.edit', ['id' => Auth::user()->id]) }}" class="dropdown-item d-block p-h-15 p-v-10">
            ...
            <div class="page-container">
                ...
                <footer class="footer">
                    <div class="footer-content">
                        <span>
                            <a href="" class="text-gray m-r-15 text-center">Term &amp; Conditions</a>
                            <a href="" class="text-gray text-left">Privacy &amp; Policy</a>
                        </span>
                    </div>
                </footer>
                <!-- Footer END -->
